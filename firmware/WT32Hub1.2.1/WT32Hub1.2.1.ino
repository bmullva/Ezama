...
void setup() {
  // Load DUAL_TEMP_LIGHTS from EEPROM
  ...
  { String _mac = ETH.macAddress(); _mac.replace(":", ""); DEVICE_ID = _mac.substring(_mac.length() - 6); }
  debugPublish("DEVICE_ID: " + DEVICE_ID + ", DUAL_TEMP_LIGHTS: " + String(DUAL_TEMP_LIGHTS));
